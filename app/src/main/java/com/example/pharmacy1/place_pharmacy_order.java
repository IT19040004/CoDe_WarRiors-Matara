...
public class place_pharmacy_order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ichoos=findViewById(R.id.imageCbtn);
        Upimg=findViewById(R.id.imgViewUp);

        placeO=findViewById(R.id.plcebtn);
        phod=new PharmacyD();

        Ichoos.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private String getFileExtension(Uri uri)
   {
    ...
    private void uploadImage() {
       final ProgressDialog pd = new ProgressDialog(this) ;
        ...
        if(imageUri != null)
        {
            final StorageReference fileRef= FirebaseStorage.getInstance().getReference().child("PharmacyD").child(System.currentTimeMillis() + "." +getFileExtension(imageUri)); //"upload"
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            //my add uploadinfo phod = new uploadinfo(taskSnapshot.getUploadSessionUri().toString());
