...
public class Pharmacy_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String values[] ={"P001 - Supipi - Supipi,Matara", "P002 - Asiri - Asiri,Nupe,Matara","P003 - Samahan - Samahan,Maradana", "P004 - Sithara - Sithara,Galle","P005 - J and K Pharmacy - JK,Kaluthra","P006 - Ananda Pharmacy - Kamburugamuwa,Matara"};
